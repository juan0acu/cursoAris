...
import com.example.androidcurso12hrsarist.imccalculator.ImcCalculatorActivity.Companion.IMC_KEY
...
class ResultIMCActivity : AppCompatActivity() {
    ...
    private lateinit var btnReCalulate: Button
    ...
    private fun initListeners() {
        btnReCalulate.setOnClickListener {
            onBackPressed()
        }
    }
    ...
    private fun initComponents() {
        ...
        btnReCalulate = findViewById(R.id.btnReCalulate)
    }
}