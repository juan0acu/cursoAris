...
class TaskViewHolder (view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun render(task: Task){
        ...
        if(task.isSelected){
            tvTask.paintFlags = tvTask.paintFlags or Paint.STRIKE_THRU_TEXT_FLAG  //para tachar el nombre
        }else{
            tvTask.paintFlags = tvTask.paintFlags and Paint.STRIKE_THRU_TEXT_FLAG.inv()  //para tachar el nombre
        }
